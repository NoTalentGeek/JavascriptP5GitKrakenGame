...
var Trail_Object = function(
    ...
    this.staticAxisMax_Int = this.Determine_staticAxisMax_Int();
...
Trail_Object.prototype.AddToArray_Trail_Object = function(){
    ...
    this.destinedAxis_Int =
        this.DetermineBatch_destinedAxis_Int_Void_indexTrue_Int_Void();
...
Trail_Object.prototype.AnimationControl_Trail_Object = function(){
    ...
    if(
        this.animationOut_Bool  == false &&
        this.prepareDelete_Bool == false
    ){ /*PENDING: this.Delete_Trail_Object();*/ }
...
Trail_Object.prototype.AnimationFix_Trail_Object = function(){
    ...
    //if(this.indexTrue_Int == 1){ console.log("Hello world!"); }
...
Trail_Object.prototype.Determine_destinedAxis_Int = function(_maxLength_Int){
    ...
    //console.log(global_play_Container_Object.x_Int);
    ...
    this.destinedAxis_Int =
        Math.round(global_play_Container_Object.x_Int + (this.indexTrue_Int + 1)*global_trailInterval_Int) - global_offset_Int;
...
Trail_Object.prototype.Determine_staticAxisMax_Int = function(){
    ...
    this.staticAxisMax_Int = global_play_Container_Object.width_Int + global_offset_Int;
...
/*==================================================*/
Trail_Object.prototype.DetermineBatch_destinedAxis_Int_Void = function(){
    ...
    for(
        ...
        if(
            ...
            global_Trail_Object_Array[i_Int].Determine_destinedAxis_Int
                (global_play_Container_Object.width);
...
/*==================================================*/
Trail_Object.prototype.DetermineBatch_destinedAxis_Int_Void_indexTrue_Int_Void = function(){
    ...
    this.DetermineBatch_indexTrue_Int_Void();
    this.DetermineBatch_destinedAxis_Int_Void();
...
/*==================================================*/
Trail_Object.prototype.DetermineBatch_indexTrue_Int_Void = function(){
...
Trail_Object.prototype.DetermineIndividual_destinedAxis_Int = function(){
    ...
    var maxLength_Int           = global_play_Container_Object.width_Int;
    var destinedAxisAlt_Int     = this.Determine_destinedAxis_Int(maxLength_Int);
...
Trail_Object.prototype.Set_endAxis_Int = function(_endAxis_Int){
    ...
    this.endAxis_Int = global_play_Container_Object.y_Int + _endAxis_Int;
...
Trail_Object.prototype.Set_startAxis_Int = function(_startAxis_Int){
    ...
    this.startAxis_Int = global_play_Container_Object.y_Int + _startAxis_Int;
...
Trail_Object.prototype.Set_staticAxis_Int = function(_staticAxis_Int){
    ...
    this.staticAxis_Int = global_play_Container_Object.x_Int + _staticAxis_Int;
