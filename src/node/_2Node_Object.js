...
var _2Node_Object = function(){
    ...
    Node_Object.call(
        this,
        global_node_Audio_Array[2],                     /*__Audio,*/
        Branch_Enum._2_BRANCH,                          /*__Branch_Enum,*/
        global_branch_Node_Object_Array[2],             /*_branch_Node_Object_Array,*/
        global_heightFix_Int,                           /*_width_Int,*/
        global_heightFix_Int,                           /*_height_Int,*/
        global_xUCNode_Int_Array[2],                    /*_xC_Int,*/
        global_nodeSpawnPointY_Int,                     /*_yC_Int,*/
        true,                                           /*_fill_Bool,*/
        true,                                           /*_stroke_Bool,*/
        global_fillNodeColor_String_Array[2],           /*_fillNodeColor_String,*/
        global_fillNodeFurthestColor_String_Array[2],   /*_fillNodeFurthestColor_String,*/
        global_fillNodeNearestColor_String_Array[2],    /*_fillNodeNearestColor_String,*/
